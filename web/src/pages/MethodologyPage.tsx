...
const safeguards = [
  [ShieldCheck, "The model never sees the market price", "The blind Qwen forecast is built only from contract text and collected evidence -- market price, bid, ask, spread, volume and liquidity are never shown to it."],
    ...
    <div className="shell-width page-space methodology-page">
      ...
      <section className="page-section methodology-section" id="primary-series">
        <div className="section-heading">
          ...
          <p>
            A local model (Qwen) is given the contract text and collected evidence only -- never the market price, bid,
      ...
      <section className="page-section pipeline-section" id="pipeline">
        <div className="section-heading">
          ...
          <p>This is the secondary, weighted-component series' own pipeline -- distinct from the primary blind-Qwen series above, which has no human-review step.</p>
        </div>
